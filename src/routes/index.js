  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'home/new', element: <GeneralHome2 /> },
        {
          path: 'companies',
          children: [
            { element: <Companies /> },
            ...
            { path: 'view/:code/:id', element: <CompaniesViewCustom /> },
            { path: 'view/:code/files', element: <CompanyFilesView /> }
          ]
        },
        {
          path: 'portfolios',
        ...
        },
        {
          ...
          children: [
            ...
            { path: 'companies/select', element: <CustomCompanySelect /> },
            { path: 'companies/:code/:id', element: <CompaniesViewCustom /> },
            { path: 'portfolios/select', element: <CustomPortfolioSelect /> },
            { path: 'portfolios/:code/:id', element: <PortfoliosViewCustom /> }
          ]
        },
        {
          path: 'mlapi',
          children: [
            // { element: <Companies /> },
            { path: 'carbonEmission', element: <MLApiCarbonEmission /> },
            { path: 'genderDiversity', element: <MLApiGenderDiversity /> },
    ...
    // New Dashboard Routes
    {
      ...
      children: [
        { element: <Navigate to="/dashboard/home" replace /> },
        { path: 'home', element: <GeneralHome2 /> },
        {
          path: 'companies',
          children: [
            { element: <Companies /> },
...
const GeneralHome2 = Loadable(lazy(() => import('../pages/dashboard/GeneralHome2')));
...
const CompanyFilesView = Loadable(lazy(() => import('../pages/dashboard/CompanyFilesView')));
...
const CustomCompanySelect = Loadable(lazy(() => import('../pages/dashboard/TemplatesCustomCompanySelect')));
const CompaniesViewCustom = Loadable(lazy(() => import('../pages/dashboard/TemplatesCustomCompanyView')));
const CustomPortfolioSelect = Loadable(lazy(() => import('../pages/dashboard/TemplatesCustomPortfolioSelect')));
const PortfoliosViewCustom = Loadable(lazy(() => import('../pages/dashboard/TemplatesCustomPortfolioView')));
const MLApiCarbonEmission = Loadable(lazy(() => import('../pages/dashboard/MLApiCarbonEmission')));
const MLApiGenderDiversity = Loadable(lazy(() => import('../pages/dashboard/MLApiGenderDiversity')));
