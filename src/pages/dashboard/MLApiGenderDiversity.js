...
// material
import { Grid, Container, Stack, TextField, Typography, Card } from '@mui/material';
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      ...
      try {
        ...
        const link = encodeURI('gender_diversity');
        // console.log(link);
    ...
    <Page title="esgwize | ML API">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[{ name: 'Home', href: PATH_DASHBOARD.root }, { name: 'ML API Demo - Gender Diversity' }]}
        />
        ...
        <br />
        <Grid>
          <Typography variant="h5">Machine Learning API - Gender Diversity</Typography>
          <Typography variant="subtitle2">
            Sample demonstration of the working API for machine learning Model on gender diversity
          </Typography>
        </Grid>
        <br />
